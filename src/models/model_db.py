...
class Admin(Base):
    __tablename__ = 'admin'
    __table_args__ = (
        PrimaryKeyConstraint('id', name='admin_pkey'),
    )
...
class Countries(Base):
    ...
    teacher: Mapped[list['Teacher']] = relationship('Teacher', back_populates='countries')
    student: Mapped[list['Student']] = relationship('Student', back_populates='countries')
...
class Dialects(Base):
    ...
    teacher: Mapped[list['Teacher']] = relationship('Teacher', secondary='teacher_dialects', back_populates='dialect')
...
class Package(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('id', name='package_pkey'),
    )
...
class Teacher(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['country'], ['countries.country_code'], name='country_FKy'),
        PrimaryKeyConstraint('id', name='teacher_pkey'),
        Index('emailx_teacher_email', 'email'),
        Index('fki_country_FKy', 'country'),
        Index('idx_teacher_id', 'id')
    )
    ...
    dialect: Mapped[list['Dialects']] = relationship('Dialects', secondary='teacher_dialects', back_populates='teacher')
    countries: Mapped['Countries'] = relationship('Countries', back_populates='teacher')
...
class Student(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['country'], ['countries.country_code'], name='country_code'),
        ForeignKeyConstraint(['dialect_id'], ['dialects.id'], ondelete='SET NULL', name='fk_student_dialect'),
        ForeignKeyConstraint(['package_id'], ['package.id'], ondelete='SET NULL', name='fk_student_package'),
        ForeignKeyConstraint(['teacher_id'], ['teacher.id'], ondelete='SET NULL', name='fk_student_teacher'),
        PrimaryKeyConstraint('id', name='student_pkey'),
        Index('emailx_student_email', 'email'),
    ...
    dialect: Mapped[Optional['Dialects']] = relationship('Dialects', back_populates='student')
    package: Mapped[Optional['Package']] = relationship('Package', back_populates='student')
    teacher: Mapped[Optional['Teacher']] = relationship('Teacher', back_populates='student')
