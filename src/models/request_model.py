...
class FilterParams(BaseModel):
    ...
    search: Optional[str] = Field(default=None, description="Search term for filtering by name or email")
    country: Optional[str] = Field(default=None, description="Filter by country")
    tel: Optional[str] = Field(default=None, validation_alias="telephone", description="Filter by telephone number")
    @field_validator("tel")
    def validate_phone(cls, v):
        if v is not None:
            return validate_phone_value(cls, v)
